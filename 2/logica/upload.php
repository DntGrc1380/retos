...
<?php
    include '../logica/functions.php';
    $directorio = '../archivos/';
    $subir_archivo = $directorio.basename($_FILES['subir_archivo']['name']);
    $descarga = $directorio. 'salida.txt';
    echo "<div>";
    if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
        echo "El archivo es válido y se cargó correctamente.<br><br>";
        procesaArchivo($subir_archivo);
        echo "<br>";
	    echo"<a href='".$descarga."' target='_blank'>Descargar archivo</a>";
    } else {
...
<h3 align="center"><div align="center"><a href="../index.html">Volver </a></div></h3></div>
